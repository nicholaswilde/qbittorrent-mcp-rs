...
- [x] Task: Run `task test:ci` to ensure no regressions were introduced.
- [x] Task: Use the MCP Inspector to verify that tool descriptions and the new prompt resource are correctly exposed.
- [x] Task: Verify that all acceptance criteria from `spec.md` have been fulfilled.
- [x] Task: Conductor - User Manual Verification 'Phase 4: Verification and Final Polish' (Protocol in workflow.md)
