...
async fn test_get_torrent_list() {
    ...
    let mock_torrents = r#"[
        {"hash": "123", "name": "Linux ISO", "size": 1024, "progress": 1.0, "dlspeed": 0, "upspeed": 0, "priority": 0, "num_seeds": 10, "num_leechs": 0, "num_incomplete": 0, "num_complete": 10, "ratio": 1.0, "eta": 0, "state": "uploading", "seq_dl": false, "f_l_piece_prio": false, "category": "", "tags": "", "super_seeding": false, "force_start": false}
    ]"#;
...
async fn test_get_torrents_info() {
    ...
    let mock_torrents = r#"[
        {"hash": "abc", "name": "Ubuntu", "size": 2048, "progress": 0.5, "dlspeed": 500, "upspeed": 10, "priority": 1, "num_seeds": 5, "num_leechs": 2, "num_incomplete": 2, "num_complete": 5, "ratio": 0.1, "eta": 60, "state": "downloading", "seq_dl": true, "f_l_piece_prio": false, "category": "linux", "tags": "os", "super_seeding": false, "force_start": false}
    ]"#;
